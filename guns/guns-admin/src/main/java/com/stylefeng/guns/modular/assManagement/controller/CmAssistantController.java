package com.stylefeng.guns.modular.assManagement.controller;
...
import com.stylefeng.guns.modular.assManagement.service.ICmAssistantService;

/**
 * 助教管理控制器
 *
 * @author fengshuonan
 * @Date 2018-12-01 17:18:22
 */
@Controller
@RequestMapping("/cmAssistant")
public class CmAssistantController extends BaseController {

    private String PREFIX = "/assManagement/cmAssistant/";
